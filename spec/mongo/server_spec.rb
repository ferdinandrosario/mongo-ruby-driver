...
describe Mongo::Server do
  ...
  describe '#==' do
    ...
    context 'when the other is a server' do
      ...
      context 'when the addresses dont match' do
        ...
        let(:other) do
          described_class.new(other_address, monitoring, listeners, TEST_OPTIONS)
        end
  ...
  describe '#initialize' do
    ...
    let(:server) do
      described_class.new(address, monitoring, listeners, TEST_OPTIONS.merge(:heartbeat_frequency => 5))
    end
